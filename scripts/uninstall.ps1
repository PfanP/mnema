...
if (-not (Test-Path $ComposeFile)) {
  Write-Err "No Mnema installation found at $InstallDir"
  exit 1
}

Write-Host ""
Write-Warn "This will permanently delete Mnema and all of your belief data."
Write-Host ""
...
Write-Host ""
Write-Info "Mnema has been uninstalled."
Write-Host ""