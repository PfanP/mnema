...
Mnema assembles a belief context on every request by combining three layers: a persona prelude, pinned facts, and relevant beliefs surfaced by text search.
