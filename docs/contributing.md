...
Mnema is early and the surface area is intentionally small. The best contributions right now are:
...
direct way to contribute. If you find a case where Mnema surfaces the wrong
