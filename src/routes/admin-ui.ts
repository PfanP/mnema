...
function navHtml() {
  return \`<nav class="nav">
    <a class="nav-brand" href="/beliefs">
      <img src="/assets/mnema-logo.png" alt="Mnema" height="24" style="vertical-align:middle">
    </a>
    <div class="nav-links">
  ...
  app.innerHTML = \`
    ...
    <div class="main">
      ...
      <div class="field">
        ...
        <div class="hint">When off, Mnema still injects your existing beliefs into every
      ...
      <div class="field" style="margin-top:1rem">
        ...
        <div class="hint">When off, Mnema stops injecting your world model into sessions.
        ...
        <div class="section">
          ...
          <div class="card">
            <div class="field">
              ...
              <div class="hint">When enabled, Mnema detects the domain from your first message each session.
...
function showTokenScreen(err) {
  ...
  <img src="/assets/mnema-logo.png" alt="Mnema" class="logo">
    <h1>Mnema</h1>
...
async function exportBackup() {
  ...
  try {
    ...
    a.href = url;
    a.download = \`mnema-backup-\${Date.now()}.enc\`;
    a.click();
