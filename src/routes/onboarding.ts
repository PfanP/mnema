...
function showTokenScreen(err) {
  ...
  <img src="/assets/mnema-logo.png" alt="Mnema" class="logo">
    <div class="header"><h1>Mnema</h1><p>Enter your API token to begin setup.</p></div>
    <div class="field">
...
function showProviderSetup(err) {
  set(\`
    <div class="header">
      ...
      <p>Mnema needs an LLM to run onboarding extraction and belief injection.</p>
    </div>
    <div class="field">
      ...
      <div class="status">
        ...
        <div style="margin-top:1.5rem;background:var(--surface);border:1px solid var(--border);border-radius:8px;padding:1rem 1.25rem;text-align:left">
          ...
          <div style="font-size:.72rem;color:var(--muted);margin-top:.4rem;opacity:.75">
            Your Mnema token is your API key — use the same value in both fields.
          </div>
          </div>
        </div>
