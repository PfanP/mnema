      ...
      <div class="section">
        ...
        <div style="background:var(--surface);border:1px solid var(--border);border-radius:7px;padding:1.25rem">
          <p style="font-size:.82rem;color:var(--muted);margin-bottom:1.25rem;line-height:1.5">
            ...
            Mnema will extract beliefs exactly as it would from a conversation.
          ...
          <div class="field">
            ...
            <div class="hint" style="font-size:.75rem;color:var(--muted);margin-top:.3rem">
              If this document belongs to a specific project, enter its tag here (e.g. project:my-app). Leave blank and Mnema will infer scope from the content.
            </div>
          </div>
          <div class="field">
